                ...
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="current">Edit Advert</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="page-content">
            <div class="inner-box">
                <div class="dashboard-box">
                    <h2 class="dashbord-title">Edit Advert</h2>
                </div>
                <div class="dashboard-wrapper">
                    <div id="root">
                    <form method="post" enctype="multipart/form-data" id="advert-form" @submit.prevent="editAdvert">
                        <div class="row">
