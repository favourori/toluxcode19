        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                <div class="widget">
                    ...
                    <ul class="menu">
                        <li>
                            <a href="#">How to Sell Faster</a>
                        </li>
                        <li>
                            <a href="#">Membership Details</a>
                        </li>
                        <li>
                            <a href="#">Why Choose</a>
                        </li>
                ...
                <div class="widget">
                    ...
                    <ul class="contact-footer">
                        <li>
                            ...
                            <span>1900 Pico Blvd, New York</span>
                        </li>
                        <li>
                            <strong>Phone :</strong>
                        ...
                        <li>
                            ...
                            <span>
                                <a href="#">
                                    <span class="__cf_email__" data-cfemail="abc2c5cdc4ebced3cac6dbc7ce85c8c4c6">[email&#160;protected]</span>
                                </a>
                            </span>
                        </li>
                    </ul>
